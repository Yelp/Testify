...
class TestRunnerServerExceptionInClassTeardownTestCase(TestRunnerServerBaseTestCase):
    def build_test_case(self):
...
class TestRunnerServerExceptionInSetupPhaseOfClassSetupTeardownTestCase(TestRunnerServerBaseTestCase):
    def build_test_case(self):
    ...
    def test_exception_during_class_teardown(self):
        ...
        # 'classTearDown' is a deprecated synonym for 'class_teardown'. We
        # don't especially care about it, but it's in there.
        expected_methods = set(['test1', 'test2', 'class_setup_teardown_raises_exception_in_setup_phase', 'classTearDown', 'run'])
        seen_methods = set()
...
class TestRunnerServerExceptionInTeardownPhaseOfClassSetupTeardownTestCase(TestRunnerServerBaseTestCase):
    def build_test_case(self):
    ...
    def test_exception_during_class_teardown(self):
        ...
        # 'classTearDown' is a deprecated synonym for 'class_teardown'. We
        # don't especially care about it, but it's in there.
        expected_methods = set(['test1', 'test2', 'class_setup_teardown_raises_exception_in_teardown_phase', 'classTearDown', 'run'])
        seen_methods = set()
