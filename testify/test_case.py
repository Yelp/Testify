...
class TestCase(object):
    ...
    EVENT_ON_RUN_SETUP_METHOD = 7
    EVENT_ON_COMPLETE_SETUP_METHOD = 8
    EVENT_ON_RUN_TEARDOWN_METHOD = 9
    EVENT_ON_COMPLETE_TEARDOWN_METHOD = 10
    EVENT_ON_COMPLETE_TEST_CASE = 11
    EVENT_ON_RUN_TEST_CASE = 12
